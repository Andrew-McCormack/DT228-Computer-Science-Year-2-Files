...
<div class="wrapper">
	<div id='cssmenu'>
		...
		<li class='active'><a href="searchByCategory.php"><span>Search For a Book By Category</span></a></li>
...
<?php
	...
	if ( isset($_GET['category']))
	{
		...
		{
			echo "<a href='searchByCategory.php?&category=$c&page=$i'>$i</a> ";
		}
		echo "</p>";
...
{
	echo "Enter the category you wish to search for!";
}
?>
</center>
</div>
